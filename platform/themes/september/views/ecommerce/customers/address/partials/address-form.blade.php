<div class="customer-address-payment-form">
        ...
        <div class="form-group">
            ...
            <div class="list-customer-address" @if (!$isAvailableAddress) style="display: none;" @endif>
                    ...
                    @if ($isAvailableAddress)
                        @foreach ($addresses as $address)
                            <option
                                    ...
                                    @endif
                            >
                                {{ $address->address }}, {{ $address->city }}, {{ $address->state }}</option>
                        @endforeach
                    @endif
                </select>
                <br>
                <div class="address-item-selected" @if (Arr::get($sessionCheckoutData, 'address_id') === 'new') style="display: none;" @endif>
                    @if ($isAvailableAddress)
                        @if ($default_address = get_default_customer_address())
                            @include('plugins/ecommerce::themes.customers.address.partials.address-item', ['address' => $default_address])
                        @else
                            @include('plugins/ecommerce::themes.customers.address.partials.address-item', ['address' => Arr::first($addresses)])
                        @endif
                    @endif
                </div>
                    ...
                    @if ($isAvailableAddress)
                        @foreach($addresses as $address)
                            <div class="address-item-wrapper" data-id="{{ $address->id }}">
                                @include('plugins/ecommerce::themes.customers.address.partials.address-item', compact('address'))
                            </div>
                        @endforeach
                    @endif
                </div>
    ...
    <div class="address-form-wrapper" @if (auth('customer')->check() && ($isAvailableAddress && (!empty(Arr::get($sessionCheckoutData, 'address_id')) && Arr::get($sessionCheckoutData, 'address_id') !== 'new')) || (auth('customer')->check() && $isAvailableAddress && empty(Arr::get($sessionCheckoutData, 'state')))) style="display: none;" @endif>
        <div class="row">
            <div class="col-12">
                <div class="form-group
             @if ($errors->has('address.name')) has-error @endif">
                    <input type="text" name="address[name]" id="address[name]" placeholder="{{ __('Full Name') }}" class="form-control checkout-input"
        ...
        <div class="row">
            <div class="col-lg-8 col-12">
                ...
                <div class="form-group  @if ($errors->has('address.email')) has-error @endif">
                    <input type="text" name="address[email]" id="address[email]" placeholder="{{ __('Email') }}" class="form-control checkout-input" value="{{ old('address.email', Arr::get($sessionCheckoutData, 'email')) }}">
                </div>
            ...
            <div class="col-lg-4 col-12">
                ...
                <div class="form-group  @if ($errors->has('address.phone')) has-error @endif">
                    <input type="text" name="address[phone]" id="address[phone]" placeholder="{{ __('Phone') }}" class="form-control checkout-input" value="{{ old('address.phone', Arr::get($sessionCheckoutData, 'phone')) }}">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-group @if ($errors->has('address.country')) has-error @endif">
                    <select name="address[country]" class="form-control" id="address[country]">
            ...
            <div class="col-sm-6 col-12">
                ...
                <div class="form-group  @if ($errors->has('address.state')) has-error @endif">
                    ...
                    <input id="address[state]" type="text" class="form-control checkout-input" placeholder="{{ __('State') }}" name="address[state]" value="{{ old('address.state', Arr::get($sessionCheckoutData, 'address')) }}">
            ...
            <div class="col-sm-6 col-12">
                ...
                <div class="form-group  @if ($errors->has('address.city')) has-error @endif">
                    <input id="address[city]" type="text" class="form-control checkout-input" placeholder="{{ __('City') }}" name="address[city]" value="{{ old('address.city', Arr::get($sessionCheckoutData, 'address')) }}">
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="form-group @if ($errors->has('address.address')) has-error @endif">
                    <input id="address[address]" type="text" class="form-control checkout-input" placeholder="{{ __('Address') }}" name="address[address]" value="{{ old('address.address', Arr::get($sessionCheckoutData, 'address')) }}">
                </div>
            </div>
        </div>
    </div>
