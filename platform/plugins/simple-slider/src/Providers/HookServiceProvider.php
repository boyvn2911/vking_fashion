    ...
    public function boot()
    {
        if (setting('simple_slider_using_assets', true) && defined('THEME_OPTIONS_MODULE_SCREEN_NAME')) {
            Theme::asset()
                ->container('footer')
                ->usePath(false)
                ->add('owl.carousel', asset('vendor/core/plugins/simple-slider/libraries/owl-carousel/owl.carousel.css'), [], [], '1.0.0')
                ->add('simple-slider-css', asset('vendor/core/plugins/simple-slider/css/simple-slider.css'), [], [], '1.0.0')
                ->add('carousel', asset('vendor/core/plugins/simple-slider/libraries/owl-carousel/owl.carousel.js'), ['jquery'], [], '1.0.0')
                ->add('simple-slider-js', asset('vendor/core/plugins/simple-slider/js/simple-slider.js'), ['jquery'], [], '1.0.0');
        }
