class ChangeProductSwatches {
    ...
    handleEvents() {
        ...
        _self.$body.off('click').on('click', '.product-attributes .visual-swatch label, .product-attributes .text-swatch label', event => {
        ...
        _self.$body.off('change').on('change', '.product-attributes input, .product-attributes select', event => {
