<template>
    <div class="flexbox-grid no-pd-none">
                                ...
                                <tr v-for="variant in child_products">
                                    <td class="width-60-px min-width-60-px">
                                        <div class="wrap-img vertical-align-m-i">
                                            <img class="thumb-image" v-bind:src="variant.image_url"
                                            ...
                                            <li v-for="product_item in list_products.data"
                                                ...
                                                <div class="wrap-img inline_block vertical-align-t float-left">
                                                    <img class="thumb-image"
                                                         v-bind:src="product_item.image_url"
                                                         v-bind:title="product_item.name">
                                                </div>
                                ...
                                <div class="panel-footer"
                                    ...
                                    <div class="btn-group float-right">
                                        <button type="button"
                                                ...
                                                v-bind:disabled="list_products.current_page === 1">
                                            <svg role="img"
                                        ...
                                        <button type="button"
                                                ...
                                                v-bind:disabled="!list_products.next_page_url">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="ui-text-area textarea-auto-height" rows="2"
                            ...
                            <div class="table-wrap">
                                <table class="table-normal table-none-border table-color-gray-text text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="pl10">{{ child_sub_amount }} {{ currency }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="pl10">{{ has_applied_discount ? child_discount_amount : 0 }} {{ currency }}</td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td class="pl10">{{ shipping_amount }} {{ currency }}</td>
                                    </tr>
                                    <tr class="text-no-bold">
                                        <td>{{ __('Total amount') }}</td>
                                        <td class="pl10">{{ child_total_amount }} {{ currency }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-lg-6 text-right">
                            <button class="btn btn-primary" v-b-modal.make-paid
                                    v-bind:disabled="!child_product_ids.length">{{ __('Paid') }}
                            </button>
                            <button class="btn btn-primary ml15" v-b-modal.make-pending
                                    v-bind:disabled="!child_product_ids.length || child_total_amount === 0">{{ __('Pay later') }}
                            </button>
                        </div>
                    </div>
                </div>
                                                        ...
                                                        <div class="flexbox-auto-40">
                                                            <div class="wrap-img inline_block vertical-align-t radius-cycle">
                                                                <img class="thumb-image radius-cycle"
                                                                     v-bind:src="customer.avatar_url">
                                                            </div>
                                                        </div>
                                                        <div class="flexbox-auto-content-right">
                                    ...
                                    <div class="panel-footer"
                                        ...
                                        <div class="btn-group float-right">
                                            <button type="button"
                                                    ...
                                                    v-bind:disabled="customers.current_page === 1">
                                                <svg role="img"
                                                     class="svg-next-icon svg-next-icon-size-16 svg-next-icon-rotate-180">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                         xlink:href="#next-chevron"></use>
                                            ...
                                            <button type="button"
                                                    ...
                                                    v-bind:disabled="!customers.next_page_url">
                                                <svg role="img" class="svg-next-icon svg-next-icon-size-16">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                         xlink:href="#next-chevron"></use>
                                                </svg>
                        ...
                        <ul class="ws-nm">
                            <li>
                                <img v-if="child_customer.avatar_url" class="width-60-px radius-cycle" alt="User Picture"
                                     v-bind:src="child_customer.avatar_url">
                            ...
                            <li>
                                <div class="flexbox-grid-default">
                                    <div class="flexbox-auto-content-left overflow-ellipsis">
                                        <a v-bind:href="'mailto:' + child_customer.email">
                            ...
                            <li class="text-infor-subdued mt15">
                                    ...
                                    <div class="ui-select-wrapper">
                                        <select class="ui-select" @change="selectCustomerAddress($event)">
                                            <option v-for="address_item in child_customer_addresses"
                                                    v-bind:value="address_item.id"
                                                    v-bind:selected="parseInt(address_item.id) === parseInt(customer_address.email)">
                                ...
                                <div>
                                    <a target="_blank" class="hover-underline"
                                       :href="'https://maps.google.com/?q=' + child_customer_address.address + ', ' + child_customer_address.city + ', ' + child_customer_address.state + ', ' + child_customer_address.country_name">{{ __('See on maps') }}</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="next-form-grid-cell">
                        ...
                        <div class="ui-select-wrapper">
                            <select class="ui-select" v-model="child_customer_address.country">
                                <option v-for="(countryName, countryCode) in countries" v-bind:value="countryCode">
                                    {{ countryName }}
                                </option>
                            </select>
                            <svg class="svg-next-icon svg-next-icon-size-16">
                    ...
                    <div class="next-form-grid-cell">
                        <div class="ui-select-wrapper">
                            <select class="ui-select">
                                <option v-bind:value="shipping_method_key" :data-name="shipping_method.name"
                                        v-for="(shipping_method, shipping_method_key) in shipping_methods"
                                        v-bind:selected="shipping_method_key === (shipping_method + ';' + shipping_option + ';' + shipping_amount)">
                ...
                <div class="next-form-grid">
                    <div class="next-form-grid-cell">
                        ...
                        <input type="text" class="next-input customer-address-name"
                               v-bind:value="child_customer_address.name">
                    </div>
                    <div class="next-form-grid-cell">
                        <label class="text-title-field">{{ __('Phone') }}</label>
                        <input type="text" class="next-input customer-address-phone"
                               v-bind:value="child_customer_address.phone">
                    </div>
                </div>
                <div class="next-form-grid">
                    <div class="next-form-grid-cell">
                        ...
                        <input type="text" class="next-input customer-address-address"
                               v-bind:value="child_customer_address.address">
                    </div>
                    <div class="next-form-grid-cell">
                        <label class="text-title-field">{{ __('Email') }}</label>
                        <input type="text" class="next-input customer-address-email"
                               v-bind:value="child_customer_address.email">
                    </div>
                </div>
                <div class="next-form-grid">
                    <div class="next-form-grid-cell">
        ...
        <b-modal id="make-paid" title="Create a new order" ok-title="Create order" cancel-title="Close"
            ...
            <br/>
            <p>{{ __('Paid amount') }} : <span>{{ child_total_amount }} {{ currency }}</span></p>
        </b-modal>
        ...
        <b-modal id="make-pending" title="Create a new order" ok-title="Create order" cancel-title="Close"
            ...
            <br/>
            <p>{{ __('Pending amount') }} : <span>{{ child_total_amount }} {{ currency }}</span></p>
        </b-modal>
