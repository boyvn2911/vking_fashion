    ...
    <div class="col-md-6 col-12">
        ...
        {!! Form::open(['route' => 'public.reviews.create', 'method' => 'post']) !!}
            ...
            <div class="form-group {{ $errors->has('star') ? ' has-error' : '' }}">
                ...
                <input type="hidden" name="star" id="rating" @if (!auth('customer')->check() || ($isReviewed = check_if_reviewed_product($productId))) disabled value="{{ get_user_reviewed_value($productId) }}" @endif/>
            </div>
