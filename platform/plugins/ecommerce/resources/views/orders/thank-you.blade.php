...
@section('content')
    <div class="col-lg-7 col-md-6 col-12 left">
        ...
        <div class="checkout-logo" style="margin-top: 30px;">
        ...
        <div class="order-customer-info">
            ...
            <p>{{ __('Address') }}: <span
                        class="order-customer-info-meta">{{ $order->address->address }}, {{ $order->address->city }}, {{ $order->address->state }}, {{ $order->address->country_name }}</span></p>
