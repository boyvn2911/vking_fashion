                                                    ...
                                                    @foreach(Cart::content() as $key => $cartItem)
                                                        @php
                                                            ...
                                                            if(!empty($product)) {
                                                                ...
                                                                $configurable_product = get_parent_product($product->id);

                                                                if (!empty($configurable_product)) {
                                                                    $cross_sell_products = array_unique(array_merge($cross_sell_products, get_cross_sale_products($configurable_product)));
                                                                }
                                                            }
                                                        @endphp
                                                    ...
                                                    @if (!empty($cross_sell_products))
                                                        ...
                                                        <div class="container product-carousel" style="margin-top: 10px;">
                                                            <div id="new-tranding" class="product-item-4 owl-carousel owl-theme nf-carousel-theme">
                                                                <!-- item.1 -->
                                                                @foreach ($cross_sell_products as $cross_id)
                                                                    {!! Theme::partial('product.product_simple', ['product' => get_product_by_id($cross_id)]) !!}
                                                                @endforeach
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="responsive-table">
                                                        <table>
                                                            ...
                                                            <tr class="order-total">
                                                                ...
                                                                {{ format_price(Cart::rawTotal() - $promotionDiscountAmount - $couponDiscountAmount) }}
                                                            </span></td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
