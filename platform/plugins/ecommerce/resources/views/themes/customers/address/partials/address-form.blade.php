                    ...
                    @if ($isAvailableAddress)
                        @foreach ($addresses as $address)
                            <option
                                    ...
                                    @endif
                            >
                                {{ $address->address }}, {{ $address->city }}, {{ $address->state }}, {{ $address->country_name }}</option>
                        @endforeach
                    @endif
                </select>
                <br>
                <div class="address-item-selected" @if (Arr::get($sessionCheckoutData, 'address_id') === 'new') style="display: none;" @endif>
                    @if ($isAvailableAddress)
                        @if ($defaultAddress = get_default_customer_address())
                            @include('plugins/ecommerce::themes.customers.address.partials.address-item', ['address' => $defaultAddress])
                        @else
