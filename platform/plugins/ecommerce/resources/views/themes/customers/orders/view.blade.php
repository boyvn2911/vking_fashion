    ...
    <div class="customer-order-detail">
        ...
        <div class="row">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach($order->products as $key => $orderProduct)
                            ...
                            <tr>
                                ...
                                <td class="text-center"><img src="{{ RvMedia::getImageUrl($product->image, 'thumb', false, RvMedia::getDefaultImage()) }}" alt="{{ $product->name }}"
                                                             width="50"></td>
                                ...
                                <td class="money text-right">
                                    <strong>
                                        {{ number_format($orderProduct->price * $orderProduct->qty, 0, '.', ',') . ' ' . $orderProduct->currency }}
                                    </strong>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="col-md-12">
                ...
                @if (in_array($order->status, [\Botble\Ecommerce\Enums\OrderStatusEnum::PENDING, \Botble\Ecommerce\Enums\OrderStatusEnum::PROCESSING]))
