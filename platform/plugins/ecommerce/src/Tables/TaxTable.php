...
class TaxTable extends TableAbstract
{
    ...
    public function columns()
    {
        return [
            ...
            'state_code' => [
                'name'  => 'ec_taxes.state_code',
                'title' => trans('plugins/ecommerce::tax.state_code'),
                'class' => 'text-center',
            ],
            'post_code'  => [
                'name'  => 'ec_taxes.post_code',
                'title' => trans('plugins/ecommerce::tax.post_code'),
                'class' => 'text-center',
            ],
            'city'       => [
                'name'  => 'ec_taxes.city',
            ...
            'status'     => [
                ...
                'title' => trans('plugins/ecommerce::tax.status'),
                'class' => 'text-center',
            ],
            'created_at' => [
