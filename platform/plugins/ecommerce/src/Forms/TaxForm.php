...
class TaxForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $this
            ...
            ->add('state_code', 'text', [
                'label'      => trans('plugins/ecommerce::tax.state_code'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'placeholder'  => trans('plugins/ecommerce::tax.state_code'),
                    'data-counter' => 120,
                ],
            ])
            ->add('post_code', 'text', [
                'label'      => trans('plugins/ecommerce::tax.post_code'),
                'label_attr' => ['class' => 'control-label'],
                'attr'       => [
                    'placeholder'  => trans('plugins/ecommerce::tax.post_code'),
                    'data-counter' => 120,
                ],
            ])
