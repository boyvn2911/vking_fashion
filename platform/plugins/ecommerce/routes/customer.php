...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Customers', 'middleware' => 'web'], function () {
...
Route::group([
    ...
    Route::get('wish-lists', [
        'as'   => 'wish-lists',
        'uses' => 'PublicController@getWishLists',
    ]);
    ...
    Route::post('wish-list/{productId}', [
        'as'   => 'wish-list.add',
        'uses' => 'PublicController@addToWishList',
    ]);

    Route::delete('wish-list/{productId}', [
        'as'   => 'wish-list.remove',
        'uses' => 'PublicController@removeWishListItem',
    ]);
